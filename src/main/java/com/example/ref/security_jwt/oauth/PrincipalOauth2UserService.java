package com.example.ref.security_jwt.oauth;
...
public class PrincipalOauth2UserService extends DefaultOAuth2UserService {
	...
	// 구글 로그인 버튼 -> 구글 로그인창 -> 로그인 완료 -> code 리턴(OAuth-client라이브러리) ->AccessToken 요청
	// userRequest 정보 -> loadUser 함수(회원프로필) -> 구글로부터 회원프로필을 받아줌(json)
	@Override
